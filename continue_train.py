...
class UnsupervisedDataset(Dataset):
    """Dataset for unsupervised pre-training."""
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer):
        ...
        tokenized_result = _tokenize_fn([example["input"] for example in list_data_dict], tokenizer)
        tokenized_ids = tokenized_result['input_ids']

        self.input_ids = [tokenized_id for tokenized_id in tokenized_ids]
        self.labels = [tokenized_id for tokenized_id in tokenized_ids]
...
def make_unsupervised_data_module(tokenizer: transformers.PreTrainedTokenizer, data_args) -> Dict:
    ...
    train_dataset = UnsupervisedDataset(tokenizer=tokenizer, data_path=data_args.data_path)
